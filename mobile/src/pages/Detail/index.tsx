...
const Detail = () => {
    ...
    useEffect(() => {
        api.get(`points/${routeParms.point_id}`).then(respose => {
    ...
    if(!data.point){
        //se trada do caso ele nao consiga carregar os dados do ponto, precisamos implementar alguma tela de load aqui
        return null
    }
